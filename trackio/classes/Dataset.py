...
from .Agent import (gen_track_meta, gen_agent_meta)
...
class Dataset:
    ...
    def group_points(self, 
        ...
        if len(raw_files) > 0:
            #process in parallel
            utils.pool_caller(processing.group_points, 
                              partials, 
                              raw_files, 
                              desc, 
                              ncores)
    ...
    def split_tracks_spatiotemporal(self,
        ...
        utils.pool_caller(processing.split_tracks_spatiotemporal,
    ...
    def split_tracks_by_data(self,
        ...
        pkl_groups = list(zip(*self.get_files_tracks_to_process(agents, tracks)))
        #process tracks in parallel
        utils.pool_caller(processing.split_tracks_by_data,
    ...
    def split_tracks_kmeans(self,
        ...
        error = utils.pool_caller(processing.split_tracks_kmeans,
                                  (n_clusters, 
                                   feature_cols, 
                                   out_pth, 
                                   return_error, 
    ...
    def split_tracks_dbscan(self,
        ...
        pkl_groups = list(zip(*self.get_files_tracks_to_process(agents, tracks)))
        #process clustering in parallel
        utils.pool_caller(processing.split_tracks_dbscan,
                            (feature_cols, 
                            out_pth, 
                            remove, 
                            eps, 
    ...
    def repair_tracks_spatiotemporal(self, 
        ...
        utils.pool_caller(processing.repair_tracks_spatiotemporal,
                          (time, 
                           distance, 
                           out_pth),
                          pkl_files,
    ...
    def remove_tracks(self,
        ...
        utils.pool_caller(processing.remove_tracks,
                          (out_pth,),
                          pkl_groups,
                          desc,
                          ncores)
    ...
    def get_track_splits(self, 
        ...
        rows = utils.pool_caller(processing.get_track_gaps,
                                 (),
                                 pkl_files,
                                 desc,
                                 ncores)
    ...
    def make_meta_mapper(self,
        ...
        _out =  utils.pool_caller(mappers.make_meta_mapper,
                                 (inp,),
                                 pkl_files,
                                 desc,
                                 ncores)
    ...
    def drop_meta(self, 
        ...
        utils.pool_caller(mappers.drop_agent_meta,
                        (inp, out_pth),
                        pkl_files,
                        desc,
                        ncores)
    ...
    def map_meta(self,
        ...
        utils.pool_caller(mappers.map_agent_meta,
    ...
    def make_data_mapper(self,
        ...
        pkl_groups = list(zip(*self.get_files_tracks_to_process(agents, tracks)))
        #read data from agents in parallel
        _out =  utils.pool_caller(mappers.make_data_mapper,
                                 (inp,),
                                 pkl_groups,
                                 desc,
                                 ncores)
    ...
    def drop_data(self, 
        ...
        pkl_files = utils.flatten(pkl_files)
        #delete data from agents in parallel
        utils.pool_caller(mappers.drop_agent_data,
                        (inp, out_pth),
                        pkl_files,
                        desc,
                        ncores)
    ...
    def map_data(self,
        ...
        utils.pool_caller(mappers.map_agent_data,
                          (inp, out, mapper, out_pth, drop, fill),
                          pkl_groups,
                          desc,
                          ncores)
    ...
    def map_data_to_codes(self,
        ...
        pkl_groups = list(zip(*self.get_files_tracks_to_process(agents, tracks)))
        #map agent data in parallel
        utils.pool_caller(mappers.map_agent_data_to_codes,
